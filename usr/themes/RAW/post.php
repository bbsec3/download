...
<div id="main" class="flex flex-1">
    <div class="center flex-1">
        ...
        <?php if(!$this->have()):?>
            <div class="post-item">
            <div class="post-item-body" style="padding-top:0.001em"><script type="text/javascript" src="//qzonestyle.gtimg.cn/qzone/hybrid/app/404/search_children.js" charset="utf-8" homePageUrl="https://transl.wang/" homePageName="回到我的主页"></script></div>
            </div>
        <?php else:?>
